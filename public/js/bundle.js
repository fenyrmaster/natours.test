        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Well done, you are logged in");
...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, password, confirmPassword) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Well done, you are registered, check your email to complete the registration");
              window.setTimeout(function () {
                location.assign("/");
              }, 3500);
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Well done, you are logged out");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("error", "Couldnt log out, try again");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "http://127.0.0.1:3000/api/v1/users/updatePassword" : "http://127.0.0.1:3000/api/v1/users/updateData";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Well done, you updated your ".concat(type));
              window.setTimeout(function () {
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"createReview.js":[function(require,module,exports) {
"use strict";
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, ID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/api/v1/tours/".concat(ID, "/reviews"),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Well done, your review is posted");
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"handleToursView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateTourInfo = void 0;
...
var updateTourInfo = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "http://127.0.0.1:3000/api/v1/tours/5c88fa8cf4afda39709c296c";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Well done, you updated the tour");
              window.setTimeout(function () {
  ...
  return function updateTourInfo(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateTourInfo = updateTourInfo;
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"confirmUser.js":[function(require,module,exports) {
"use strict";
...
var confirmUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(string) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/api/v1/users/confirm/".concat(string)
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Well done, you confirmed your identity");
              window.setTimeout(function () {
                location.assign("/");
              }, 3500);
            }
  ...
  return function confirmUser(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var bookTours = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51IdPJkJuRD4PH3yd7CQiXyEUG0uy0eK4okaVji28WW4Zrp5WnQA0wla1Xaor6qBDRsSmqM2EQivOYtfPi5lynRke00WIC91pZX");
            _context.prev = 1;
            _context.next = 4;
  ...
  return function bookTours(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookTours = bookTours;
...
var _handleToursView = require("./handleToursView");
...
var logoutB = document.querySelector(".nav__el--logout");
...
var formUp = document.querySelector(".form-user-data");
var formPass = document.querySelector(".form-user-settings");
var formRe = document.querySelector(".form-user-review");
var formUpIMG = document.getElementById("uploadPics");
var confirm = document.getElementById("confirm");
var bookTour = document.getElementById("book-tour");
...
if (formPass) {
  formPass.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var password, newPassword, newPasswordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _updateSettings.updateUserData)({
                password: password,
...
if (formRe) {
  formRe.addEventListener("submit", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var review, rating, select, tourID;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              select = document.getElementById("tour");
              tourID = select.options[select.selectedIndex].id;
              ...
              return _context2.abrupt("return", (0, _alerts.showAlert)("error", "You have to select a tour"));

            case 7:
              _context2.next = 9;
              return (0, _createReview.createReview)(review, rating, tourID);
...
if (formUpIMG) {
  formUpIMG.addEventListener("click", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var form, image1, image2, image3, imageCover;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              (0, _handleToursView.updateTourInfo)(form);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1886" + '/');
